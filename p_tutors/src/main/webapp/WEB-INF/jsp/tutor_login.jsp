    ...
    <body style="background:lightblue" >
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <br>
                    <label  style="font-size:35px;font-family: serif">Tutor Log In :</label> 
                     <br>
                    ...
                    <br>
                    <br>
                    <b style="color: darkslategrey;" style='font-family: serif'> Don't have an account ?</b>&nbsp; <a href="tutor_reg1.jsp"><button type="button" class="btn btn-success" style="font-size: 15px;">Register</button></a>
                     </center>
                </div>
