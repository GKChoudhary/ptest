        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <br>
                    <br>
                    <b style="color: darkslategrey;" style='font-family: serif'> Don't have an account ?</b>&nbsp; <a href="student_reg1.jsp"><button type="button" class="btn btn-success" style="font-size: 15px;">Register</button></a>
                     </center>
                </div>
